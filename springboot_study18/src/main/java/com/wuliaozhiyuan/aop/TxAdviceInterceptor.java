 ...
 * </pre>
 *
 * @author : https://github.com/yujunhao8831/spring-boot-start-current/blob/master/aidijing-basic-config/src/main/java/com/aidijing/config/TransactionalConfig.java
 */
@Configuration
